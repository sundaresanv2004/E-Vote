...
def settings_election_options_animation(container_var):
    container_var.height = 250 if container_var.height == 45 else 45
    container_var.update()


def settings_user_options_animation(container_var):
    container_var.height = 350 if container_var.height == 45 else 45
    container_var.update()


def settings_admin_options_animation(container_var):
    container_var.height = 350 if container_var.height == 45 else 45
    container_var.update()
